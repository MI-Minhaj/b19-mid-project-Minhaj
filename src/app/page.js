...
<div className="grid grid-cols-3 gap-4 mb-6 bg-gray-800 p-4 rounded-lg">
      ...
      {showExpenseModal && (
        <div className="fixed inset-0 bg-black bg-opacity-50 flex justify-center items-center">
          <div className="bg-white p-6 rounded-lg shadow-lg w-96">
            <h2 className="text-lg font-bold mb-4 text-black">Add Expenses</h2>
  ...
  <ResponsiveContainer width="100%" height={200}>
    <PieChart>
      <Pie
        ...
        labelLine={false} // Hides the lines pointing outside
  ...
  <div className="flex space-x-4 mt-2 text-white text-sm">
    {data.map((item, index) => (
      ...
      {/* Heading */}
      <h3 className="text-2xl font-semibold italic mb-4">Recent Transactions</h3>
      ...
      <div className="bg-white p-4 rounded-xl shadow-lg">
        {transactions.map((t) => (
          ...
          >
            ...
            <div className="flex items-center gap-3">
              <span className="text-yellow-500 font-semibold">₹{t.amount}</span>
      ...
      <div className="flex justify-center items-center mt-4 gap-3">
        ...
        <span className="bg-green-500 text-white px-4 py-1 rounded-lg">1</span>
        <button className="bg-gray-300 p-2 rounded-full text-gray-700 hover:bg-gray-400">
          →
        </button>
      </div>
